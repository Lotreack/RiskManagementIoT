...
public class Xiaomi_Mi_WiFi_Router_Nano {

    String type = "Router";
    String name = "Xiaomi_Mi_WiFi_Router_Nano";
    public double[] Xiaomi_Mi_WiFi_Router_Nano_vulnerabilities = new double[19];
    ...
    * */
    ...
    public Xiaomi_Mi_WiFi_Router_Nano() throws IOException {
    ...
    public void KeyboardInput () throws IOException {
        ...
        for (int i = 0; i < 19; i++)
        {
            ...
            Xiaomi_Mi_WiFi_Router_Nano_vulnerabilities[i] = Double.parseDouble(reader.readLine()) * availability * importance * k;
