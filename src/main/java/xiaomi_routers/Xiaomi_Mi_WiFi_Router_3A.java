...
public class Xiaomi_Mi_WiFi_Router_3A {

    String type = "Router";
    String name = "Xiaomi_Mi_WiFi_Router_3A";
    public double[] Xiaomi_Mi_WiFi_Router_3A_vulnerabilities = new double[19];
    ...
    * */
    ...
    public Xiaomi_Mi_WiFi_Router_3A() throws IOException {
    ...
    public void KeyboardInput () throws IOException {
        ...
        for (int i = 0; i < 19; i++)
        {
            ...
            Xiaomi_Mi_WiFi_Router_3A_vulnerabilities[i] = Double.parseDouble(reader.readLine()) * availability * importance * k;
