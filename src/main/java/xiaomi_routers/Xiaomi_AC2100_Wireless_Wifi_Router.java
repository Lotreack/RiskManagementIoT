...
public class Xiaomi_AC2100_Wireless_Wifi_Router {

    String type = "Router";
    String name = "Xiaomi_AC2100_Wireless_Wifi_Router";
    public double[] Xiaomi_AC2100_Wireless_Wifi_Router_vulnerabilities = new double[19];
    ...
    * */
    ...
    public Xiaomi_AC2100_Wireless_Wifi_Router() throws IOException {
    ...
    public void KeyboardInput () throws IOException {
        ...
        for (int i = 0; i < 19; i++)
        {
            ...
            Xiaomi_AC2100_Wireless_Wifi_Router_vulnerabilities[i] = Double.parseDouble(reader.readLine()) * availability * importance * k;
