...
public class Xiaomi_Mi_WiFi_Router_2_1TB {

    String type = "Router";
    String name = "Xiaomi_Mi_WiFi_Router_2_1TB";
    public double[] Xiaomi_Mi_WiFi_Router_2_1TB_vulnerabilities = new double[19];
    ...
    * */
    ...
    public Xiaomi_Mi_WiFi_Router_2_1TB() throws IOException {
    ...
    public void KeyboardInput () throws IOException {
        ...
        for (int i = 0; i < 19; i++)
        {
            ...
            Xiaomi_Mi_WiFi_Router_2_1TB_vulnerabilities[i] = Double.parseDouble(reader.readLine()) * availability * importance * k;
