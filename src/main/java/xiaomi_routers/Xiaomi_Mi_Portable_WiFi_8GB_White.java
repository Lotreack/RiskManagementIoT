...
public class Xiaomi_Mi_Portable_WiFi_8GB_White {

    String type = "Router";
    String name = "Xiaomi_Mi_Portable_WiFi_8GB_White";
    public double[] Xiaomi_Mi_Portable_WiFi_8GB_White_vulnerabilities = new double[19];
    ...
    * */
    ...
    public Xiaomi_Mi_Portable_WiFi_8GB_White() throws IOException {
    ...
    public void KeyboardInput () throws IOException {
        ...
        for (int i = 0; i < 19; i++)
        {
            ...
            Xiaomi_Mi_Portable_WiFi_8GB_White_vulnerabilities[i] = Double.parseDouble(reader.readLine()) * availability * importance * k;
