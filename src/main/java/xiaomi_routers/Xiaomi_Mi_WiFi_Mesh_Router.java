...
public class Xiaomi_Mi_WiFi_Mesh_Router {

    String type = "Router";
    String name = "Xiaomi_Mi_WiFi_Mesh_Router";
    public double[] Xiaomi_Mi_WiFi_Mesh_Router_vulnerabilities = new double[19];
    ...
    * */
    ...
    public Xiaomi_Mi_WiFi_Mesh_Router() throws IOException {
    ...
    public void KeyboardInput () throws IOException {
        ...
        for (int i = 0; i < 19; i++)
        {
            ...
            Xiaomi_Mi_WiFi_Mesh_Router_vulnerabilities[i] = Double.parseDouble(reader.readLine()) * availability * importance * k;
