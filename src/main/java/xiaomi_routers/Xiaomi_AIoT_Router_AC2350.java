...
public class Xiaomi_AIoT_Router_AC2350 {
    String type = "Router";
    String name = "Xiaomi_AIoT_Router_AC2350";
    public double[] Xiaomi_AIoT_Router_AC2350_vulnerabilities = new double[19];
    ...
    * */
    ...
    public Xiaomi_AIoT_Router_AC2350() throws IOException {
