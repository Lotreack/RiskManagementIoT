...
public class Xiaomi_AIoT_Router_AX9000 {

    String type = "Router";
    String name = "Xiaomi_AIoT_Router_AX9000";
    public double[] Xiaomi_AIoT_Router_AX9000_vulnerabilities = new double[19];
    ...
    * */
    ...
    public Xiaomi_AIoT_Router_AX9000() throws IOException {
    ...
    public void KeyboardInput () throws IOException {
        ...
        for (int i = 0; i < 19; i++)
        {
            ...
            Xiaomi_AIoT_Router_AX9000_vulnerabilities[i] = Double.parseDouble(reader.readLine());
