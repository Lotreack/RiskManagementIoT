...
public class Xiaomi_Mi_Powerline_WiFi_Adapter {

    String type = "Router";
    String name = "Xiaomi_Mi_Powerline_WiFi_Adapter";
    public double[] Xiaomi_Mi_Powerline_WiFi_Adapter_vulnerabilities = new double[19];
    ...
    * */
    ...
    public Xiaomi_Mi_Powerline_WiFi_Adapter() throws IOException {
    ...
    public void KeyboardInput () throws IOException {
        ...
        for (int i = 0; i < 19; i++)
        {
            ...
            Xiaomi_Mi_Powerline_WiFi_Adapter_vulnerabilities[i] = Double.parseDouble(reader.readLine()) * availability * importance * k;
