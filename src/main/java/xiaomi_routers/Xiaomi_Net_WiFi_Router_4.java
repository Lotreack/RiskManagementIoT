...
public class Xiaomi_Net_WiFi_Router_4 {

    String type = "Router";
    String name = "Xiaomi_Net_WiFi_Router_4";
    public double[] Google_Home_Voice_Controller_vulnerabilities = new double[19];
    ...
    * */
    ...
    public Xiaomi_Net_WiFi_Router_4() throws IOException {
