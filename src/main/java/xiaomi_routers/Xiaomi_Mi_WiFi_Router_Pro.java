...
public class Xiaomi_Mi_WiFi_Router_Pro {

    String type = "Router";
    String name = "Xiaomi_Mi_WiFi_Router_Pro";
    public double[] Xiaomi_Mi_WiFi_Router_Pro_vulnerabilities = new double[19];
    ...
    * */
    ...
    public Xiaomi_Mi_WiFi_Router_Pro() throws IOException {
    ...
    public void KeyboardInput () throws IOException {
        ...
        for (int i = 0; i < 19; i++)
        {
            ...
            Xiaomi_Mi_WiFi_Router_Pro_vulnerabilities[i] = Double.parseDouble(reader.readLine()) * availability * importance * k;
