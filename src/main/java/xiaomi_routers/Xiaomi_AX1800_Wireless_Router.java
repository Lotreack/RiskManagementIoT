...
public class Xiaomi_AX1800_Wireless_Router {

    String type = "Router";
    String name = "Xiaomi_AX1800_Wireless_Router";
    public double[] Xiaomi_AX1800_Wireless_Router_vulnerabilities = new double[19];
    ...
    * */
    ...
    public Xiaomi_AX1800_Wireless_Router() throws IOException {
