...
public class Mi_Home_Mijia_Honeywell_Smoke_Detector {
    String type = "Sensor";
    String name = "Mi_Home_Mijia_Honeywell_Smoke_Detector";
    public double[] Mi_Home_Mijia_Honeywell_Smoke_Detector_vulnerabilities = new double[127];
    ...
    * */
    ...
    public Mi_Home_Mijia_Honeywell_Smoke_Detector() throws IOException {
    ...
    public void KeyboardInput () throws IOException {
        ...
        for (int i = 0; i < 127; i++)
        {
            ...
            Mi_Home_Mijia_Honeywell_Smoke_Detector_vulnerabilities[i] = Double.parseDouble(reader.readLine()) * availability * importance * k;
