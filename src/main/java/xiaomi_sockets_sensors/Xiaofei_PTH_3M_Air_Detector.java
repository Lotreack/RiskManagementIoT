...
public class Xiaofei_PTH_3M_Air_Detector {

    String type = "Sensor";
    String name = "Xiaofei_PTH_3M_Air_Detector";
    public double[] Xiaofei_PTH_3M_Air_Detector_vulnerabilities = new double[2];
    ...
    * */
    ...
    public Xiaofei_PTH_3M_Air_Detector() throws IOException {
