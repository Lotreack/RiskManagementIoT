...
public class Amazon_Echo_fourth_gen {

    String type = "AWS";
    String name = "Amazon_Echo_fourth_gen";
    public double[] Amazon_Echo_fourth_gen_vulnerabilities = new double[1];
    ...
    * */
    ...
    public Amazon_Echo_fourth_gen() throws IOException {
    ...
    public void KeyboardInput () throws IOException {
        ...
        for (int i = 0; i < 1; i++)
        {
            ...
            Amazon_Echo_fourth_gen_vulnerabilities[i] = Double.parseDouble(reader.readLine()) * availability * importance;
