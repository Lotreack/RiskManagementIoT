...
public class August_WiFi_Smart_Lock {

    String type = "AWS";
    String name = "August_WiFi_Smart_Loc";
    ...
    * */
    ...
    public August_WiFi_Smart_Lock() throws IOException {
    ...
    public void KeyboardInput () throws IOException {
        ...
        for (int i = 0; i < 1; i++)
        {
            ...
            August_WiFi_Smart_Loc_vulnerabilities[i] = Double.parseDouble(reader.readLine());
