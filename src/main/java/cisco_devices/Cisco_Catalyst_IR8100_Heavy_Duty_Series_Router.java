...
public class Cisco_Catalyst_IR8100_Heavy_Duty_Series_Router {

    String type = "Router";
    String name = "Cisco_Catalyst_IR8100_Heavy_Duty_Series_Router";
    public double[] Cisco_Catalyst_IR8100_Heavy_Duty_Series_Router_vulnerabilities = new double[1];
    ...
    * */
    ...
    public Cisco_Catalyst_IR8100_Heavy_Duty_Series_Router() throws IOException {
    ...
    public void KeyboardInput () throws IOException {
        ...
        for (int i = 0; i < 1; i++)
        {
            ...
            Cisco_Catalyst_IR8100_Heavy_Duty_Series_Router_vulnerabilities[i] = Double.parseDouble(reader.readLine()) * availability * importance;
