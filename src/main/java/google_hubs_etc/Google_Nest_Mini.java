...
public class Google_Nest_Mini {

    String type = "Hub";
    String name = "Google_Nest_Mini";
    public double[] Google_Nest_Mini_vulnerabilities = new double[48];
    ...
    * */
    ...
    public Google_Nest_Mini() throws IOException {
