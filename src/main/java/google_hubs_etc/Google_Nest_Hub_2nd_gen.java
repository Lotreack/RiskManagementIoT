...
public class Google_Nest_Hub_2nd_gen {

    String type = "Hub";
    String name = "Google_Nest_Hub_2nd_gen";
    public double[] Google_Nest_Hub_2nd_gen_vulnerabilities = new double[48];
    ...
    * */
    ...
    public Google_Nest_Hub_2nd_gen() throws IOException {
